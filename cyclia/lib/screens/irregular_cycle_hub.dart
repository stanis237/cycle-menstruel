        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 12),
              Text("Focus : SOPK", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF4A148C))),
            ],
          ),
          SizedBox(height: 12),
          Text(
            "Le Syndrome des Ovaires Polykystiques (SOPK) touche 1 femme sur 10. C'est l'une des causes majeures de cycles irréguliers.",
          ...
          Text("• Cycles très longs (> 35 jours)\n• Acné persistante ou pilosité\n• Fatigue inexpliquée", style: TextStyle(fontSize: 12)),
        ],
      ),
    );
  }
