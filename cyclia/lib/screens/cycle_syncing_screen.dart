            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildExerciseList(List<String>.from(data['exercises'])),
                  const SizedBox(height: 16),
                  _buildInfoCard(
      ...
      children: exercises.map((ex) => Container(
        ...
        child: Row(
          children: [
            ...
            Text(ex, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
          ],
        ),
      )).toList(),
    );
  ...
  Map<String, dynamic> _getSyncingData(String phase) {
    if (phase.contains("Règles")) {
      return {
        ...
        "exercises": ["Yoga doux", "Marche lente", "Étirements légers"],
      ...
      return {
        ...
        "exercises": ["HIIT / Cardio", "Course à pied", "Danse dynamique"],
      ...
      return {
        ...
        "exercises": ["Cyclisme", "Musculation", "Nouveaux cours collectifs"],
      ...
      return {
        ...
        "exercises": ["Pilates", "Natation", "Marche active"],
