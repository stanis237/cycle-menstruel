  ...
  Future<void> _loadProfileData() async {
    ...
    if (profile != null) {
      ...
      setState(() {
        ...
        _isDiscreet = pDetails['is_discreet_mode'] ?? false;
        _isPremium = pDetails['is_premium'] ?? false;
        _lastSync = lastSync;
      });
    }
                    ...
                    child: Column(
                      children: [
                        SwitchListTile(
                          ...
                          onChanged: (val) => setState(() => _privacyEnabled = val),
                        ),
                        SwitchListTile(
                          contentPadding: EdgeInsets.zero,
                          title: const Text("Mode Discret"),
                          subtitle: const Text("Masque les termes sensibles sur l'accueil"),
                          value: _isDiscreet,
                          activeThumbColor: const Color(0xFF8E24AA),
                          onChanged: (val) => setState(() => _isDiscreet = val),
                        ),
                      ],
                    ),
                  ),
