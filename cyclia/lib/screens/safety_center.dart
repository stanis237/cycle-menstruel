      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 32),
            const Text("Tests & Détection", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF4A148C))),
            const SizedBox(height: 16),
            _buildGuideCard(
              "Quand faire un test ?",
              "Attendez au moins le 1er jour de retard des règles (environ 14 jours après le rapport) pour un résultat fiable.",
