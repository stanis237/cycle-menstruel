      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildFeatureRow(Icons.psychology, "Analyses IA avancées", "Comprenez les liens entre vos symptômes et votre mode de vie."),
            _buildFeatureRow(Icons.picture_as_pdf, "Rapports PDF illimités", "Exportez vos données pour vos rendez-vous médicaux."),
            _buildFeatureRow(Icons.chat, "Assistant Santé Prioritaire", "Réponses instantanées et conseils personnalisés 24/7."),
            _buildFeatureRow(Icons.emoji_events_rounded, "Badges Élite Exclusifs", "Accédez à des défis et récompenses réservés aux membres Pro."),
              ...
              onPressed: () async {
                ...
                if (success) {
                  await NotificationService().showPromotion(
                    ...
                    "Votre abonnement a été activé. Découvrez vos nouvelles analyses et badges Élite."
                  );
