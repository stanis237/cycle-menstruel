...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Widget _buildCustomCell(DateTime day, Color textColor, {bool showMarkerBg = true}) {
    ...
    final bool usedProt = entry != null && entry['used_contraception'] == true;
    ...
    return Padding(
      ...
      child: Wrap(
        ...
        children: [
          ...
          _buildLegendItem("Protégé", const Color(0xFF4CAF50), isShield: true),
        ],
      ),
    );
  }

  Widget _buildLegendItem(String label, Color color, {bool isStar = false, bool isHeart = false, bool isShield = false}) {
    Widget icon;
    if (isStar) {
      ...
      icon = Icon(Icons.shield_rounded, size: 14, color: color);
    } else {
      icon = Container(
        width: 12,
        height: 12,
